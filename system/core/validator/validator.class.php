...
class Core_Form_Validator {
    ...
    {
        DEBUG_MODE ? Core::mark('validator.init') : null;
    }
    ...
    /**
     * Determinar si estámos en proceso de validación...
     * 
     * @access public
     * @return bool
     */
    ...
    {
        return (($this->_isOn !== true) ? false : true);
    }
    ...
    public function setValue($field, $default)
    {
        ...
        return $this->_fieldData[$field]['value'];
    }
